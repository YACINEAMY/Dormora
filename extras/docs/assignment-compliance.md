...
| Create UML diagrams | UML class diagram is included as PDF, Draw.io, SVG, and PlantUML under `extras/docs/`; room-assignment sequence diagram is also included. |
...
- **UML documentation:** class diagram PDF/Draw.io files and sequence diagram source are included under `extras/docs/`.
